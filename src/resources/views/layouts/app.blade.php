...
<body class="bg-origin-body">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @endif
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('questionnaires.create') }}">お客様アンケート</a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="wrapper">
        <footer>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body top-text">
                                ...
                                <p>この利用規約（以下，「本規約」といいます。）は，Kartech（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                ...
                <div class="modal fade" id="privacy-policy">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body top-text">
                                <p>Kartech（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
            ...
            <a href="https://twitter.com/kzk_engineer">@kzk-engineer</a>
        </footer>
    </div>
</body>
</html>
